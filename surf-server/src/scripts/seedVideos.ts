...
const FAKE_COMMENTS = [
  'Đỉnh quá chủ thớt ơi! 🤩', 'Video cuốn quá!', 'Bao giờ ra phần tiếp theo vậy bạn?',
  'Xin link nhạc với ạ 🎵', 'Mình xem đi xem lại nãy giờ không chán', 'Tuyệt vời! 🔥',
  'Quay bằng máy gì mà nét thế?', 'Haha, cười đau cả ruột 🤣', 'Hay quá, lưu lại học hỏi thôi.',
  'Đỉnh của chóp luôn 💯', 'Người chơi hệ xuất sắc', 'Nghe vô lý nhưng lại rất thuyết phục 🤔',
  'Ủng hộ bạn 1 tim ❤️', 'Idol của lòng em', 'Bác nói chí phải!'
];
...
async function seedVideos() {
  ...
  for (const file of files) {
    ...
    const videoData = {
      ...
      description: 'Video chất lượng cao từ dự án Surf 🌊 #' + randomItem(['surf', 'trending', 'foryou', 'highlight']),
      videoUrl: publicUrl,
      thumbnailUrl: null,
      duration: 0,
