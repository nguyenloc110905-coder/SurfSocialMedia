...
export const PRIVACY_CHECKUP_TOPICS = [
  {
    id: 'visibility',
    title: 'Ai có thể xem nội dung bạn chia sẻ',
    hint: 'Bài viết, Surf Clips, ảnh',
    icon: 'globe',
    accent: 'from-surf-primary to-cyan-400',
  },
  {
    id: 'find',
    title: 'Cách mọi người tìm thấy bạn trên Surf',
    hint: 'Tìm kiếm, lời mời kết bạn',
    icon: 'people',
    accent: 'from-sky-500 to-surf-secondary',
  },
  {
    id: 'data',
    title: 'Dữ liệu và quyền kiểm soát',
    hint: 'Tải dữ liệu, xóa tài khoản',
    icon: 'lock',
  ...
  },
  {
    ...
    icon: 'shield',
    accent: 'from-surf-primary to-blue-500',
  },
  {
    id: 'ads',
    title: 'Tùy chọn quảng cáo',
    hint: 'Quảng cáo phù hợp với bạn',
    icon: 'bell',
...
export const DEFAULT_AUDIENCE_OPTIONS: {
  ...
  title: string;
  desc: string;
  icon: 'globe' | 'people' | 'gear';
}[] = [
  {
    value: 'public',
    title: 'Công khai',
    desc: 'Mọi người đều có thể xem và tương tác với nội dung bạn chia sẻ.',
    icon: 'globe',
  },
  {
    value: 'friends',
    title: 'Bạn bè',
    desc: 'Chỉ bạn bè thấy nội dung của bạn. Bài đăng công khai chỉ bạn bè mới bình luận được.',
    icon: 'people',
  },
  {
    value: 'custom',
    title: 'Tùy chỉnh',
    desc: 'Bạn chọn từng đối tượng cho từng loại nội dung. Có thể đổi bất kỳ lúc nào.',
    icon: 'gear',
  },
];
...
export const REVIEW_ITEMS: {
  title: string;
  getValue: (audience: 'public' | 'friends' | 'custom') => string;
  icon: 'person' | 'comment' | 'globe' | 'people' | 'search';
}[] = [
  {
    title: 'Ai có thể xem bài đăng, Tin 24h và Surf Clips?',
    getValue: (a) => (a === 'public' ? 'Công khai' : a === 'friends' ? 'Bạn bè' : 'Tùy chỉnh'),
    icon: 'person',
  },
  {
    title: 'Ai có thể bình luận bài đăng công khai?',
    getValue: (a) => (a === 'public' ? 'Công khai' : a === 'friends' ? 'Bạn bè' : 'Tùy chỉnh'),
    icon: 'comment',
  },
...
export const CUSTOM_SETTING_OPTIONS: CustomSettingValue[] = [
  'public',
  'friends',
  'only_me',
  'friends_except',
