              ...
              {section.items.map((item) => {
                ...
                return (
                  <li key={item.label}>
                    ...
                    >
                      <span
                        className={`[&_svg]:!text-current opacity-90 group-hover:opacity-100 ${isActive ? 'text-surf-primary dark:text-surf-secondary' : 'text-surf-primary dark:text-surf-secondary'}`}
                      >
