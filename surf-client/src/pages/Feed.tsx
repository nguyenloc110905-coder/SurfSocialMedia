...
export default function Feed() {
  ...
  return (
    <div className="max-w-[750px] mx-auto py-6 px-4">
      ...
      {error && (
        <div className="bg-red-500/10 border border-red-500/50 rounded-xl p-4 mb-4 text-red-400 text-center">
          {error}
        </div>
      )}
      ...
      {!loading && !error && posts.length === 0 && (
        <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-12 text-center border border-slate-700/50">
          ...
          <h3 className="text-xl font-semibold text-gray-300 mb-2">Chưa có bài viết nào</h3>
