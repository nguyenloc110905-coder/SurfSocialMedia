/** Icon component dùng chung cho Cài đặt */
import { iconCls } from './settings-constants';
...
export function SettingsIcon({ name }: { name: string }) {
  ...
  if (name === 'globe')
    return (
      <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
        <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95c-.32-1.25-.78-2.45-1.38-3.56 1.84.63 3.37 1.91 4.33 3.56zM12 4.04c.96 1.29 1.73 2.69 2.21 4.16h-4.42c.48-1.47 1.25-2.87 2.21-4.16zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2s.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56-1.84-.63-3.37-1.9-4.33-3.56zm2.95-8H4.26C4.1 10.64 4 11.31 4 12s.1 1.36.26 2h2.95c-.08-.66-.14-1.32-.14-2s.06-1.34.14-2zM12 19.96c-.96-1.29-1.73-2.69-2.21-4.16h4.42c-.48 1.47-1.25 2.87-2.21 4.16zM14.66 14c.08-.66.14-1.32.14-2s-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z" />
      </svg>
    );
  if (name === 'like')
    return (
  ...
  if (name === 'tag')
    return (
      <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-4 14H4v-6h12v6zm4-8H4V6h16v4z" />
      </svg>
    );
  if (name === 'block')
    return (
