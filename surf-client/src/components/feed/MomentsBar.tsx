    ...
    <div className="mb-4">
      ...
      <div className="relative bg-gradient-to-r from-cyan-50/80 via-blue-50/80 to-purple-50/80 dark:from-slate-800/50 dark:via-slate-800/50 dark:to-slate-800/50 rounded-2xl p-4 border border-cyan-200/50 dark:border-slate-700/50">
        ...
        <div className="flex gap-4 overflow-x-auto scrollbar-hide">
              ...
              <div className="relative w-full h-full rounded-[14px] overflow-hidden bg-white dark:bg-slate-800">
                ...
                {user?.photoURL ? (
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-100 via-blue-100 to-purple-100 dark:from-slate-700 dark:via-slate-600 dark:to-slate-700">
                    ...
                    >
                      <path
                        d="M0,40 Q25,25 50,40 T100,40 L100,100 L0,100 Z"
                    ...
                    {/* Decorative elements */}
                    <div
                      className="absolute top-4 left-4 w-6 h-6 rounded-full bg-cyan-400/30 dark:bg-cyan-500/20 animate-bounce"
                      style={{ animationDelay: '0s' }}
                    ></div>
                    <div
                      className="absolute top-8 right-6 w-4 h-4 rounded-full bg-blue-400/30 dark:bg-blue-500/20 animate-bounce"
                      style={{ animationDelay: '0.3s' }}
                    ></div>
                    <div
                      className="absolute bottom-24 left-8 w-5 h-5 rounded-full bg-purple-400/30 dark:bg-purple-500/20 animate-bounce"
          ...
          {moments.length > 0 &&
            moments.map((moment) => (
              <div key={moment.id} className="flex-shrink-0 group cursor-pointer">
